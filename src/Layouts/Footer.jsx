          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div className="widget">
                <h3 className="footer-logo"><img src="/src/assets/images/logo.png" alt="" style={styleImageLogo}/></h3>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
              ...
              <ul className="address">
                <li>
                  <a href="#"><i className="lni-map-marker"></i> 105 Madison Avenue - <br/> Third Floor New York, NY 10016</a>
                </li>
                <li>
